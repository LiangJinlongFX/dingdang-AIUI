...
+ LED2
  ...
  + 绿灯：用于系统解析指示，处于解析状态则绿灯闪烁，处于静默状态则绿灯长亮
...
+ 进行简单的减法运算
  ...
  描述：触发此功能后，机器人会模拟一个现实生活情景(如，小明一家吃苹果)，随机生成一个交互式的数学减法问答对，并代入到情景对话中，并能根据回答正确与否给予小朋友表扬或鼓励

+ 进行九九乘法表以内的乘法运算

  关键字：乘法表/九九乘法表

  描述：触发此功能后，机器人从九九乘法表以内随机生成一个交互式的数学乘法问答对，系统
